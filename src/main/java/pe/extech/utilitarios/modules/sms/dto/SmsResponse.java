 ...
 *
 * Incluye contexto del plan (consumoActual, limiteMaximo), información del
 * servicio
 * (servicioNombre, servicioCodigo, servicioDescripcion) y los datos reales
 * devueltos
 * por Infobip (data: messageId, to, status*).
 *
 * consumoActual refleja el conteo después de registrar este request (consumo
 * anterior + 1).
