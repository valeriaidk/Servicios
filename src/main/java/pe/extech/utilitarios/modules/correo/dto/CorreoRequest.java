package pe.extech.utilitarios.modules.correo.dto;
...
public record CorreoRequest(
        ...
        @NotBlank(message = "El campo 'operation' es obligatorio (ej: EMAIL.SEND)") String operation,
        ...
        @NotEmpty(message = "El campo 'to' es obligatorio y debe tener al menos un destinatario") List<@NotBlank(message = "Los destinatarios no pueden ser vacíos") String> to,
