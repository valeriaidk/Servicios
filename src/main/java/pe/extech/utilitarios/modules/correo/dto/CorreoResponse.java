 ...
 * - servicioNombre / servicioCodigo / servicioDescripcion → identifican el
 * servicio consumido.
 * - data → detalles del envío: modo, template, destinatarios y referencia del
 * proveedor.
 *
...
public record CorreoResponse(
         ...
         * providerReference → referencia única generada por el proveedor
         * (GRAPH_<timestamp>)
         */
        @JsonInclude(JsonInclude.Include.NON_NULL)
