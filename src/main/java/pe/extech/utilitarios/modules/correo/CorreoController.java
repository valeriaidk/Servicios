 ...
 *
 * <p>
 * Expone un único endpoint POST {@code /api/v1/servicios/correo/enviar} que
 * recibe el
 * {@link pe.extech.utilitarios.modules.correo.dto.CorreoRequest} validado con
 * {@code @Valid}, extrae
...
public class CorreoController {
    ...
    @Operation(summary = "Enviar correo electrónico", description = """
