...
/**
 * Repositorio de autenticación — agrupa las consultas necesarias para el flujo
 * de
 * login, registro y gestión del perfil de usuario.
 *
 * Actúa como fachada: algunas operaciones delegan en {@link UsuarioRepository}
 * (para reutilizar lógica ya encapsulada) y otras llaman directamente a SPs
 * propios
...
public class AuthRepository {
    ...
    /**
     * Obtiene el plan activo del usuario para incluirlo en el JWT y la respuesta de
     * login.
     *
     ...
     *
     * Columnas retornadas: {@code PlanId}, {@code Nombre}
     * (FREE/BASIC/PRO/ENTERPRISE).
     *
     * Retorna mapa vacío si el usuario no tiene plan activo. En ese caso,
     * {@link pe.extech.utilitarios.modules.auth.AuthService} no puede generar el
     * JWT
     ...
     * en {@code IT_PlanFuncionLimite} para ese plan, unida con
     ...
     *         configurados (ej: ENTERPRISE — no hay filas en
     ...
     *
     * @return mapa con los datos del usuario, o mapa vacío si no existe o está
     *         eliminado
     */
