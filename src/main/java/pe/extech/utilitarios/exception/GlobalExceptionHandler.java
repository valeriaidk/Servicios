...
public class GlobalExceptionHandler {
        ...
        /**
         * En QAS (true): el body completo del proveedor se incluye en el campo
         * "detalles"
         ...
         */
        @Value("${extech.debug.exponer-error-proveedor:true}")
        ...
        public ResponseEntity<ErrorResponse> handleProveedorExterno(ProveedorExternoException ex) {
                ...
                // bodyProveedor solo se expone en el response si el flag de debug está activo
                // (QAS).
                // En producción siempre queda en los logs del servidor (ver log.error más
                // abajo).
        ...
        public ResponseEntity<ErrorResponse> handleIllegalArgument(IllegalArgumentException ex) {
                // Incluye: DNI_INVALIDO, RUC_INVALIDO, TELEFONO_INVALIDO, template no
                // encontrado, etc.
                // El mensaje viene de ValidadorUtil o de la resolución de contenido/plantilla
                // en los UseCases.
                return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
        ...
        public ResponseEntity<ErrorResponse> handleMetodoNoPermitido(
        ...
        public ResponseEntity<ErrorResponse> handleParametroAusente(MissingServletRequestParameterException ex) {
                return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY)
                                .body(new ErrorResponse(
                                                "PARAMETRO_REQUERIDO",
                                                "El parámetro '" + ex.getParameterName()
                                                                + "' es obligatorio y no fue enviado."));
        }
         ...
         *
         * Requiere spring.mvc.throw-exception-if-no-handler-found=true en
