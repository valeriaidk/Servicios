 ...
 *
 * <p>Estructura idéntica a {@link pe.extech.utilitarios.reniec.ReniecRepository}:
 * encapsula la llamada al SP {@code uspResolverApiExternaPorUsuarioYFuncion} con el
 * código de función {@code SUNAT_RUC}, sin acceso directo a las tablas
 * {@code IT_ApiAsignacion} ni {@code IT_ApiExternaFuncion}.</p>
 *
...
public class SunatRepository {
    ...
    /**
     * Resuelve toda la configuración del proveedor Decolecta para la función SUNAT_RUC.
     *
     ...
     * llamada toda la configuración del proveedor asignado a la función SUNAT_RUC.</p>
     *
     ...
     * @return Mapa con las columnas descritas arriba, listo para ser consumido por {@link SunatService}
     */
