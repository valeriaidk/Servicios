 ...
 *
 * <p>Expone un único endpoint POST {@code /api/v1/servicios/sms/enviar} que recibe el
 * {@link pe.extech.utilitarios.sms.dto.SmsRequest} validado con {@code @Valid}, extrae
 ...
 * a {@link ISmsService}.</p>
 *
 * <p>Este controller no contiene lógica de negocio: solo coordina la recepción del
 * request y la entrega del response. Toda validación de teléfono, resolución de template,
 * llamada a Infobip y registro de consumo ocurren en {@link SmsService}.</p>
 *
